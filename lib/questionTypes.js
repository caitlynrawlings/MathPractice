...
import genLinearInequalityGraph from "./generators/writeInequality";
import genSufficientInformation from "./generators/sufficientInfo";
import genOrderFractionsDecimalsPercentsRandom from "./generators/orderNumbers";
import genCardProbability from "./generators/cardProb";
import genGeometricSequence from "./generators/geometricSeq";
import genEstimateAverage from "./generators/estimateAverage";
import genParallelLinesAngles from "./generators/parallelLinesAngles";
import genFunctionClaims from "./generators/functionClaims";
import genRectanglePerimeter from "./generators/perimeter";
...
export const QUESTION_TYPES = [
  ...
  { id: "writeInequality", name: "Write Inequality", icon: "", generate: genLinearInequalityGraph },
  { id: "sufficientInfo", name: "Sufficent Information", icon: "", generate: genSufficientInformation },
  { id: "orderNumbers", name: "Order Numbers", icon: "", generate: genOrderFractionsDecimalsPercentsRandom },
  { id: "cardProbability", name: "Card Probability", icon: "", generate: genCardProbability },
  { id: "geometricSequence", name: "Geometric Sequence", icon: "", generate: genGeometricSequence },
  { id: "estimateAverage", name: "Estimate Average", icon: "", generate: genEstimateAverage },
  { id: "angleRelationships", name: "Angle Relationships", icon: "", generate: genParallelLinesAngles },
  { id: "functionClaims", name: "Function Claims", icon: "", generate: genFunctionClaims },
  { id: "perimeter", name: "Perimeter", icon: "", generate: genRectanglePerimeter },
